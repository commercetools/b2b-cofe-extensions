...
CategoryRouter.loadFor = (request, frontasticContext) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (urlMatches) {
        ...
        const productQuery = ProductQueryFactory.queryFromParams(Object.assign({}, request));
...
CategoryRouter.loadPreviewFor = (request, frontasticContext) => __awaiter(void 0, void 0, void 0, function* () {
    var _g, _h, _j, _k, _l;
    const productApi = new ProductApi(frontasticContext, getLocale(request));
    const urlMatches = (_g = getPath(request)) === null || _g === void 0 ? void 0 : _g.match(/\/preview\/(.+)/);
    if (urlMatches) {
        const categoryQuery = {
            slug: urlMatches[1],
        };
